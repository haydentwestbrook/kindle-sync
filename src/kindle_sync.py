...
class KindleSync:
    ...
    def copy_to_kindle_usb(self, pdf_path: Path, kindle_path: Optional[Path] = None) -> bool:
    ...
    def sync_from_kindle(self, kindle_path: Optional[Path] = None, sync_folder: Optional[Path] = None) -> List[Path]:
