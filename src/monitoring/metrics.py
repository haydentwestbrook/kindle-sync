...
class MetricsCollector:
    ...
    def __init__(self, config: Optional[Config] = None, db_manager: Optional[DatabaseManager] = None):
        ...
        # Collection settings
        self.collection_interval = config.get("monitoring.metrics_interval", 60)  # seconds
    ...
    async def _collect_memory_metrics(self):
        ...
        try:
            ...
            self.record_gauge("system.memory.available.percent", 
                            (memory.available / memory.total) * 100, unit="percent")
    ...
    async def _collect_disk_metrics(self):
        ...
        try:
            ...
            self.record_gauge("system.disk.percent", (used / total) * 100, unit="percent")
    ...
    async def _collect_filesystem_metrics(self):
        ...
        try:
            ...
            for suffix, count in file_counts.items():
                self.record_gauge("filesystem.files.count", count, 
    ...
    def record_gauge(self, name: str, value: float, tags: Optional[Dict[str, str]] = None, unit: Optional[str] = None):
    ...
    def _record_metric(self, name: str, value: float, tags: Optional[Dict[str, str]], 
                      metric_type: str, unit: Optional[str] = None):
