...
class ProcessedFile(Base):
    ...
    # Relationships
    operations = relationship("FileOperation", back_populates="file", cascade="all, delete-orphan")
...
class ProcessingQueue(Base):
    ...
    scheduled_for = Column(DateTime, nullable=True, index=True)  # For delayed processing
    retry_count = Column(Integer, default=0)
