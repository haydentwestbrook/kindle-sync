...
class TracingManager:
    ...
    def __init__(self, service_name: str = "kindle-sync", config: Optional[Dict[str, Any]] = None):
        """
    ...
    def set_span_status(self, status_code: str, description: Optional[str] = None):
        ...
        if current_span and current_span.is_recording():
            ...
            status = Status(StatusCode.ERROR if status_code == "ERROR" else StatusCode.OK, description)
...
def initialize_tracing(service_name: str = "kindle-sync", config: Optional[Dict[str, Any]] = None) -> bool:
    """
