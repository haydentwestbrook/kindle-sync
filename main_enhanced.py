...
from src.business_metrics import initialize_business_metrics
from src.caching import initialize_cache_manager
from src.config import Config
from src.core.async_file_watcher import AsyncFileWatcher
from src.core.async_processor import AsyncSyncProcessor
from src.database import DATABASE_AVAILABLE, DatabaseManager
...
from src.rate_limiting import initialize_rate_limiter
        ...
        try:
            ...
            if rate_limit_config.get("enabled", True):
                ...
                self.rate_limiter = initialize_rate_limiter(
                    limiter_type, self.cache_manager
                )
