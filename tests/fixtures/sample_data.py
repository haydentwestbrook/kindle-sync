...
%%EOF"""
    ...
    SAMPLE_FILE_EVENTS = [
        {"type": "created", "path": "/tmp/test_document.md", "is_directory": False},
        {"type": "modified", "path": "/tmp/test_document.md", "is_directory": False},
        {"type": "moved", "path": "/tmp/test_document_moved.md", "is_directory": False},
    ]
    ...
    SAMPLE_FILE_PATHS = {
        ...
        "images": ["/tmp/diagram.png", "/tmp/screenshot.jpg", "/tmp/photo.jpeg"],
    }

    # Sample directory structures
    SAMPLE_DIRECTORY_STRUCTURE = {
        "obsidian_vault": {
            "Kindle Sync": {"Drafts": {}, "Final": {}, "Archive": {}},
            "Templates": {
                "meeting_template.md": "content",
                "project_template.md": "content",
            },
            "Backups": {"2024-01-15": {}, "2024-01-14": {}},
        }
    }
    ...
    def get_sample_file_path(cls, file_type: str, index: int = 0) -> str:
        ...
        return cls.SAMPLE_FILE_PATHS[file_type][
            index % len(cls.SAMPLE_FILE_PATHS[file_type])
        ]
