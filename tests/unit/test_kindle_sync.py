...
class TestKindleSync:
    ...
    def test_send_pdf_to_kindle_custom_subject(self, config, temp_dir, sample_pdf_content):
    ...
    def test_send_pdf_to_kindle_smtp_error(self, config, temp_dir, sample_pdf_content):
        ...
        with patch.object(kindle_sync, '_send_email', side_effect=Exception("SMTP error")):
            result = kindle_sync.send_pdf_to_kindle(pdf_file)
    ...
    def test_copy_to_kindle_usb_default_path_linux(self, config, temp_dir, sample_pdf_content):
        ...
        with patch('pathlib.Path.exists') as mock_exists:
            mock_exists.side_effect = lambda: str(default_kindle_path) in str(Path.cwd()) or str(default_kindle_path) == str(default_kindle_path)
    ...
    def test_copy_to_kindle_usb_kindle_path_not_found(self, config, temp_dir, sample_pdf_content):
    ...
    def test_backup_file_success(self, config, temp_dir, sample_pdf_content):
        ...
        with patch.object(kindle_sync.config, 'get_sync_config', return_value={'backup_originals': True, 'backup_folder': str(backup_folder)}):
    ...
    def test_backup_file_error(self, config, temp_dir, sample_pdf_content):
        ...
        with patch.object(kindle_sync.config, 'get_sync_config', return_value={'backup_originals': True, 'backup_folder': '/invalid/path'}):
    ...
    def test_sync_from_kindle_success(self, config, temp_dir):
        ...
        with patch.object(kindle_sync.config, 'get_sync_folder_path', return_value=sync_folder):
