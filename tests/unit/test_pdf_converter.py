...
class TestMarkdownToPDFConverter:
    ...
    def test_convert_markdown_to_pdf_success(self, mock_markdown, mock_html, converter, temp_markdown_file):
        """Test successful markdown to PDF conversion."""
        # Mock markdown conversion
        mock_markdown.return_value = "<h1>Test Document</h1><p>This is a test document.</p>"
    ...
    @patch('src.pdf_converter.weasyprint.HTML')
    @patch('src.pdf_converter.markdown.markdown')
    def test_convert_markdown_to_pdf_with_custom_output(self, mock_markdown, mock_html, converter, temp_markdown_file):
    ...
    @patch('src.pdf_converter.weasyprint.HTML')
    @patch('src.pdf_converter.markdown.markdown')
    def test_convert_markdown_to_pdf_conversion_error(self, mock_markdown, mock_html, converter, temp_markdown_file):
    ...
    @patch('src.pdf_converter.weasyprint.HTML')
    @patch('src.pdf_converter.markdown.markdown')
    def test_convert_markdown_to_pdf_pdf_generation_error(self, mock_markdown, mock_html, converter, temp_markdown_file):
...
class TestPDFToMarkdownConverter:
    ...
    def test_convert_pdf_to_markdown_success(self, mock_ocr, mock_convert, converter, temp_pdf_file):
    ...
    @patch('src.pdf_converter.pdf2image.convert_from_path')
    @patch('src.pdf_converter.pytesseract.image_to_string')
    def test_convert_pdf_to_markdown_with_custom_output(self, mock_ocr, mock_convert, converter, temp_pdf_file):
    ...
    @patch('src.pdf_converter.pdf2image.convert_from_path')
    def test_convert_pdf_to_markdown_conversion_error(self, mock_convert, converter, temp_pdf_file):
    ...
    @patch('src.pdf_converter.pdf2image.convert_from_path')
    @patch('src.pdf_converter.pytesseract.image_to_string')
    def test_convert_pdf_to_markdown_ocr_error(self, mock_ocr, mock_convert, converter, temp_pdf_file):
    ...
    @patch('src.pdf_converter.pdf2image.convert_from_path')
    @patch('src.pdf_converter.pytesseract.image_to_string')
    def test_convert_pdf_to_markdown_empty_text(self, mock_ocr, mock_convert, converter, temp_pdf_file):
