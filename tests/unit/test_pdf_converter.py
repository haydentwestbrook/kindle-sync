...
class TestMarkdownToPDFConverter:
    ...
    def test_convert_markdown_to_pdf_success(self, config, temp_dir, sample_markdown_content):
        ...
        with patch.object(converter, '_generate_pdf') as mock_generate:
            with patch.object(converter, '_process_markdown') as mock_process:
                mock_process.return_value = "<html><body>Processed content</body></html>"
    ...
    def test_convert_markdown_to_pdf_custom_output(self, config, temp_dir, sample_markdown_content):
...
class TestPDFToMarkdownConverter:
    ...
    def test_convert_pdf_to_markdown_success(self, config, temp_dir, sample_pdf_content):
    ...
    def test_convert_pdf_to_markdown_custom_output(self, config, temp_dir, sample_pdf_content):
    ...
    def test_convert_pdf_to_markdown_missing_dependencies(self, config, temp_dir, sample_pdf_content):
    ...
    def test_convert_pdf_to_markdown_multiple_pages(self, config, temp_dir, sample_pdf_content):
