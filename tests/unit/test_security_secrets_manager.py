...
from src.core.exceptions import SecretsError, ErrorSeverity
...
class TestSecretsManager:
    ...
    def test_get_secret_from_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(secrets_manager, 'decrypt_secret', return_value='decrypted_password'):
                secret = secrets_manager.get_secret("smtp_password")
    ...
    def test_get_secret_default_value(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            secret = secrets_manager.get_secret("nonexistent_secret", default="default_value")
    ...
    def test_set_secret(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(secrets_manager, 'encrypt_secret', return_value='encrypted_value'):
    ...
    def test_migrate_plaintext_secrets(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(secrets_manager, 'encrypt_secret', return_value='encrypted_password'):
                migrated_config = secrets_manager.migrate_plaintext_secrets(plaintext_config)
                
                assert migrated_config["kindle"]["smtp_password"] == "encrypted:encrypted_password"
    ...
    def test_encrypt_secret_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(secrets_manager.cipher, 'encrypt', side_effect=Exception("Encryption failed")):
    ...
    def test_decrypt_secret_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(secrets_manager.cipher, 'decrypt', side_effect=Exception("Decryption failed")):
                with pytest.raises(SecretsError) as exc_info:
    ...
    def test_nested_config_access(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            secrets_manager._set_nested_value(config, "level1.level2.new_value", "new_test_value")
