...
from src.core.retry import with_retry, retry_on_network_error, retry_on_file_error
from src.core.exceptions import FileProcessingError, EmailServiceError
...
class TestWithRetry:
    ...
    def test_retry_only_on_specific_exceptions(self):
        ...
        @with_retry(max_attempts=3, retry_exceptions=(ValueError,), wait_min=0.01, wait_max=0.1)
...
class TestRetryWithCustomExceptions:
    ...
    def test_retry_with_custom_exception(self):
        ...
        @with_retry(max_attempts=3, retry_exceptions=(FileProcessingError,), wait_min=0.01, wait_max=0.1)
